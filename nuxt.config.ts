  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://mrsunshyne.github.io/mauritius-fuel-prices/og-image.png' },
        ...
        { name: 'twitter:image', content: 'https://mrsunshyne.github.io/mauritius-fuel-prices/og-image.png' },
      ],
      link: [
